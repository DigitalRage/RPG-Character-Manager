#BB 1st Skill & Stat Manager Project
...
def setup_char_value(): 
    ...
    while True:
        ...
        added_dic = {
            'Stats': {'MP': 0, 'HP': 0, 'Str': 0, 'Atk': 0, 'Def': 0, 'Mag': 0, 'Spr': 0, 'Acc': 0, 'Spd': 0, 'Evs': 0, 'Lvl': 0}
        } 
        ...
        def mult_level(): 
            ...
            char_table_lv1[clas]['stats']['lvl'] = new_level
            for key in char_table_lv1[clas]['Stats']: 
